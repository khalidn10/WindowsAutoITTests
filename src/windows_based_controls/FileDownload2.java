...
public class FileDownload2 {
	...
	public static WebElement elementReady(WebDriver driver, String cssLocator)
	{
		...
		return fWait.until(new Function<WebDriver, WebElement>()
	    {
	    	...
	    	public WebElement apply(WebDriver driver)
	    	{
	    		...
	    		List<WebElement> cnb = driver.findElements(By.cssSelector(cssLocator));
	    		...
	    		if (cnb.size() == 1)
	    		{
	    			...
	    			String jSScript = "var element = document.querySelector(\"" + cssLocator + "\");" +
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		elementReady(driver, ".g-btn.g-btn--primary.g-btn--medium").click();
